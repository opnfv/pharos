...
class Utilities:
    ...
    def pingHost(self):
        ...
        i = 0
        response = 1
        cmd = "ping -c 1 "+self.host+" >/dev/null 2>&1"
    ...
    def copyDir(self, localDir, remoteDir):
        ...
        cmd += localDir+"* root@"+self.host+":"+remoteDir
    ...
    def changePassword(self):
        ...
        Generates a random string and sets the root password
        """
        paswd = ''
        chars = string.ascii_uppercase + string.digits
        for x in range(15):
            paswd += random.SystemRandom().choice(chars)
